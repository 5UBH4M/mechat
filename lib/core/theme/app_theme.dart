  ...
  static ThemeData buildCustomTheme(CustomThemeModel model) {
    return ThemeData(
      ...
      colorScheme: ColorScheme(
        ...
        onPrimary: model.senderTextColor,
        secondary: model.secondaryColor,
        onSecondary: Colors.white,
        secondaryContainer: model.receiverBubbleColor,
        onSecondaryContainer: model.receiverTextColor,
        surface: model.surfaceColor,
        onSurface: model.receiverTextColor,
        error: accentColor,
